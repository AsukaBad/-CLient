...
namespace KiraiLibs.UI
{
    ...
    public class QMNestedButton
    {
        ...
        public void initButtonX(int btnXLocation, int btnYLocation, String btnText, System.Action btnAction, String btnToolTip, Color? btnBackgroundColor = null, Color? btnTextColor = null, Color? backbtnBackgroundColor = null, Color? backbtnTextColor = null)
        {
            ...
            mainButton = new QMSingleButton(btnQMLoc, btnXLocation, btnYLocation, btnText, () => { QuickMenuStuff.ShowQuickmenuPage(menuName); } + btnAction, btnToolTip, btnBackgroundColor, btnTextColor);
    ...
    public class QMSlider
    {
        ...
        {
            Slider = UnityEngine.Object.Instantiate(QuickMenuStuff.GetVRCUiMInstance().field_Public_GameObject_0.transform.Find("Screens/Settings/VolumePanel/VolumeGameWorld"), parent).gameObject;
        ...
        {
            Slider = UnityEngine.Object.Instantiate(QuickMenuStuff.GetVRCUiMInstance().field_Public_GameObject_0.transform.Find("Screens/Settings/VolumePanel/VolumeGameWorld"), QuickMenuStuff.GetQuickMenuInstance().transform.Find(parent.getMenuName())).gameObject;
            GameObject.Destroy(Slider.GetComponent<UiSettingConfig>());
    ...
    public class QuickMenuStuff
    {
        ...
        // Internal cache of the Social Tab Button Template
        private static GameObject STabButtonReference;
        ...
        public static GameObject STabButtonTemplate()
        {
            if (STabButtonReference == null)
            {
                STabButtonReference = GameObject.Find("UserInterface/MenuContent/Backdrop/Header/Tabs/ViewPort/Content/WorldsPageTab").gameObject;
            }
            return STabButtonReference;
        }
